...
pushd $ROOT/vault &> /dev/null
    ...
    eosc tx create dfuseioice addidea '{"author":"bigontiktok", "pool_name":"hackathon", "title":"TikTokChain", "description":"Lets bring blockchain to TikTok. TikTok pre-sale pricing available for all dfuse employees who vote favourably!"}' -p bigontiktok    # transaction_id => 2
    eosc tx create dfuseioice addidea '{"author":"mohawkbeard", "pool_name":"hackathon", "title":"ICE", "description":"Impact, Confidence, Ease of Implementation. As you can see, its already implemented, so you should all vote 10!"}' -p mohawkbeard    # transaction_id => 3
    ...
    eosc tx create dfuseioice addidea '{"author":"weenie", "pool_name":"hackathon2", "title":"Free coffee", "description":"Im tired of ordering coffee. Coffee is now a free for all. Dont let the name of the idea confuse you!"}' -p weenie    # transaction_id => 4
