...
const demoTransaction = {
  actions: [{
    ...
    name: 'transfer',
    authorization: [{
      actor: 'dfuseioice', // use account that was logged in
      permission: 'active',
    }],
    data: {
      from: 'dfuseioice', // use account that was logged in
      to: 'eosio',
      quantity: '1.0000 EOS',
      memo: 'UAL rocks!',
    },
...
ReactDOM.render(
  <UALProvider chains={[exampleNet]} authenticators={[ledger, lynx, scatter, anchor]} appName={'My App'}>
    <TestAppConsumer />
  </UALProvider>,
